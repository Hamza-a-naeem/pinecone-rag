#!/usr/bin/env python3
"""
Script to ingest company documents into Pinecone using all-mpnet-base-v2 model.

This script uses the higher-quality all-mpnet-base-v2 embedding model (768 dimensions)
...
PINECONE_INDEX_NAME = os.getenv("PINECONE_INDEX_NAME_MPNET", "company-docs-mpnet")  # Different index name
EMBEDDING_MODEL = "all-mpnet-base-v2"
EMBEDDING_DIMENSION = 768  # 768 for all-mpnet-base-v2
...
def main():
    ...
    print("=" * 60)
    print("🚀 Company Docs Copilot - MPNet Embedding Ingestion")
    print("=" * 60)
